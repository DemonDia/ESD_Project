    ...
    function showAllJobs() {
        ...
        request.onload = function() {  
            ...
            for (var job in jobs) {
                ...
                temp = '<tr><th scope="row"><a href="http://192.168.0.125:5010/job/\''+job+'\'" class="link-primary">'+job_title+'</th><td>'+company+'</td><td>'+employment_type+'</td><td>'+datetime+'</td><td>'+vacancy+'</td></tr>';
                job_list += temp;
            }
