...
############   Owner_Notification queue    #############
#delcare Owner_Notification queue
queue_name = 'Owner_Notification'
channel.queue_declare(queue=queue_name, durable=True)
    # 'durable' makes the queue survive broker restarts

#bind Owner_Notification queue
channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key='ownerNotification') 
    # bind the queue to the exchange via the key

############   User_Notification queue    #############
#delcare User_Notification queue
queue_name = 'User_Notification'
channel.queue_declare(queue=queue_name, durable=True)
    # 'durable' makes the queue survive broker restarts

#bind User_Notification queue
channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key='userNotification') 
    # bind the queue to the exchange via the key
